...
const Financ = () => {
    ...
    const submitHandler = (e) => {
        ...
        if(oS !== ''&& client !== '' && paymentType !== '' && Number(amount)>0 && Number(amount)-Number(received)>=0 && image1 !== '' && image2 !== ''){
    ...
    const fetchFinanceData = () => {
        ...
        fetch(`/finance`)
            ...
            .then(res => {
                if(!!res.result){
                    let sortedArray = res.result.sort((a, b) => a.updated_at.valueOf() - b.updated_at.valueOf())
